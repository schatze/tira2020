...
final static int MAX=100000;
    ...
    public static long operaatioita = 0;
    ...
    */
    ...
    public static void selectSort() {
        ...
        System.out.println("\nKuittaa tulos, paina Enter. Operaatioita: " + operaatioita);
        Lue.merkki();
    ...
    public static void merge(int t[], int p, int q, int r) {
        ...
        while (i<q+1)
                tau[k++]=t[i++];operaatioita++;
        while (j<r+1)
                tau[k++]=t[j++];operaatioita++;
